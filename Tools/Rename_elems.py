...
# Вспомогательная функция для переименовывания элементов датасета.
# Необходима, чтоб не было мусорки в датасете из-за того что изображения брались с разных источников
